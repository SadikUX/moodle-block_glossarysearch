...
class block_glossarysearch_edit_form extends block_edit_form {
    ...
    protected function specific_definition($mform) {
        ...
        $mform->addElement('text', 'config_customtitle',
        ...
        $mform->setDefault('config_customtitle',
        ...
        $mform->addElement('select', 'config_glossaryid',
            get_string('configglossary', 'block_glossarysearch'), $options);
